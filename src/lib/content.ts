...
export const content = {
  es: {
    ...
    booking: {
      ...
      title: "Elige tu hora. Te lo confirmamos por WhatsApp.",
      subtitle:
        "Selecciona servicio, día y hora. Al pulsar reservar se abre WhatsApp con tu solicitud ya escrita — solo tienes que enviarla.",
      ...
      submitBtn: "Reservar por WhatsApp",
  ...
  en: {
    ...
    booking: {
      eyebrow: "Book online",
      title: "Pick your time. We'll confirm on WhatsApp.",
      subtitle:
        "Choose a service, day and time. Tapping book opens WhatsApp with your request already written — just hit send.",
  ...
  fr: {
    ...
    booking: {
      ...
      title: "Choisissez votre heure. Confirmation sur WhatsApp.",
      subtitle:
        "Choisissez un service, un jour et une heure. En appuyant sur réserver, WhatsApp s'ouvre avec votre demande déjà rédigée — il ne reste qu'à l'envoyer.",
      serviceLabel: "Service",
      ...
      submitBtn: "Réserver sur WhatsApp",
  ...
  de: {
    ...
    booking: {
      ...
      title: "Zeit wählen. Bestätigung per WhatsApp.",
      subtitle:
        "Wählen Sie Leistung, Tag und Uhrzeit. Beim Tippen auf Buchen öffnet sich WhatsApp mit Ihrer fertig geschriebenen Anfrage — nur noch abschicken.",
