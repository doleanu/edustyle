    ...
    <section id="precios" className="section bg-cream-100">
      <div className="container-tight">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="section-heading mt-3">Tarifas claras. Sin sorpresas.</h2>
          <p className="section-subheading mx-auto">
            Estos son nuestros servicios y precios. ¿Dudas sobre lo que
            necesitas? Escríbenos y te asesoramos.
          </p>
        </div>
        ...
        <div className="mx-auto mt-8 max-w-5xl">
          <div className="rounded-2xl border-l-4 border-terracotta-500 bg-cream-50 px-5 py-4">
            <p className="text-sm italic text-teal-800/85">{pricing.note}</p>
          </div>
